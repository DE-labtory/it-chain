...
func TestNewPBFTConsensusService(t *testing.T) {
	...
	pbftService := NewPBFTConsensusService(comm,nil,&domain.Peer{PeerID:"1"},nil,nil)
...
func TestPBFTConsensusService_StartConsensus(t *testing.T) {
	...
	pbftService := NewPBFTConsensusService(connctionManager,nil,&domain.Peer{PeerID:"1"},nil,nil)
	block := &domain.Block{}
