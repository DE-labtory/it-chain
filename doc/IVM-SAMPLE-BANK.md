...
1. run it-chain
   ```
   [root@itchain it-chain]# it-chain
...
2. deploy
   - run deploy
   ```
   [root@itchain it-chain]# it-chain ivm deploy github.com/nesticat/bank-icode
...
3. invoke mint
   - run invoke mint
   ```
   [root@itchain it-chain]# it-chain ivm invoke bank-icode_cfea3fecf8921495dfa3ae975ad175dbebaaa9cd mint sykwon 10000
   ...
   [root@itchain it-chain]#
   [root@itchain it-chain]# it-chain ivm invoke bank-icode_cfea3fecf8921495dfa3ae975ad175dbebaaa9cd mint smoon 10000
...
4. invoke transfer
   - run invoke transfer
   ```
   [root@itchain it-chain]# it-chain ivm invoke bank-icode_cfea3fecf8921495dfa3ae975ad175dbebaaa9cd transfer sykwon smoon 1000
...
5. query accounts
   - run query accounts
   ```
   [root@itchain it-chain]# it-chain ivm query bank-icode_cfea3fecf8921495dfa3ae975ad175dbebaaa9cd accounts
...
6. query balance
   - run query balance
   ```
   [root@itchain it-chain]# it-chain ivm query bank-icode_cfea3fecf8921495dfa3ae975ad175dbebaaa9cd balance sykwon
   ...
   [root@itchain it-chain]#
   [root@itchain it-chain]# it-chain ivm query bank-icode_cfea3fecf8921495dfa3ae975ad175dbebaaa9cd balance smoon
...
7. undeploy
   - run undeploy
   ```
   [root@itchain it-chain]# it-chain ivm undeploy bank-icode_cfea3fecf8921495dfa3ae975ad175dbebaaa9cd
